...
public class ManageIssueBookView {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    manageIssueBookModel.updateIssueBookDatabase();
                    break whileLoop;
                default:
    ...
    public void showIssuedBook(ArrayList<IssueBook> issuedBookDetails) {
        System.out.println(
                "\n---------------------------------------------------------------------------------------------" +
                        "\nBook ID |  Book Name  |  User ID  |  User Name  |  Book Issue Date       |   Book Return Date" +
                        "\n---------------------------------------------------------------------------------------------"
        );
        for(IssueBook issueBook : issuedBookDetails){
            System.out.println(issueBook.getBookId()+"\t|"+issueBook.getBook().getBookName()+"\t|"+issueBook.getUser().getUserId()+"\t|"+issueBook.getUser().getUserName()+"\t|"+issueBook.getUserBookIssueDate()+"\t|"+issueBook.getUserBookReturnDate());
        }
        System.out.println(
                "\n---------------------------------------------------------------------------------------------"
        );
