...
public class LoginView {
    ...
    public LoginView() {
        LibraryDatabase.getInstance().deserializeLibrarianCredentials(); // For New Pass Key Check
        LibraryDatabase.getInstance().deserializeLibraryDetails();// For Library check
